...
public class MoveTopActivity extends AppCompatActivity implements WebSocketMessageListener  {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        ...
        if(id == R.id.back){
            Intent connect_act=new Intent(MoveTopActivity.this,connect.class);
            startActivity(connect_act);
            return true;
        }
        else if(id == R.id.operate) {
            Intent operate_act=new Intent(MoveTopActivity.this,operate.class);
            startActivity(operate_act);
            return true;
        }
        else if(id == R.id.report){
            Intent report_act=new Intent(MoveTopActivity.this,GraphsActivity.class);
            ...
            if (action.equals("failToConnect")) {// Handle connection failure
                ...
                runOnUiThread(() -> {
                    if(status.equals("stopSpinning"))
                    {
                        ...
                        isTopSpinning.setText("Not Spinning");  // Set text
                        isTopSpinning.setTextColor(ContextCompat.getColor(MoveTopActivity.this, R.color.red));  // Set text color
                    }
                    if(status.equals("startSpinning")) {
                        MainClass.top_is_spinning = true;
                        isTopSpinning.setText("Spinning...");  // Set text
                        isTopSpinning.setTextColor(ContextCompat.getColor(MoveTopActivity.this, R.color.green));  // Set text color
                    }
                });
            }
        } catch (Exception e) {
